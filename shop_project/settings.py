...
SECRET_KEY = 'mqt)kd_rf5u+_qm31fxtwz!r)lpu45!kws^!$k(lyw@d48j(44'
...
MIDDLEWARE = [
    ...
    'middleware.product_middleware.CheckExpired'
]
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'context_processors.shop.CountProducts.product_count'
            ],
        },
    },
]
